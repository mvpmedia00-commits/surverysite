...
create table if not exists public.model_applications (
  ...
  model_opportunity text not null default '',
  opportunity_interest text not null default '',
  portfolio_link text,
  regular_availability text,
...
alter table public.model_applications
  ...
  add column if not exists model_opportunity text not null default '',
  add column if not exists opportunity_interest text not null default '',
  add column if not exists portfolio_link text,
  add column if not exists regular_availability text,
